...
import servingwebcontent.com.sys.entity.Student_volunteer;
import servingwebcontent.com.sys.entity.Student_volunteerKey;
...
public interface Student_volunteerRepository extends JpaRepository<Student_volunteer,Student_volunteerKey>
{
    ...
    List<Student_volunteer> findAllByIdentificationNumber(String identificationNumber);//按身份证号查找
    List<Student_volunteer> findAllBySerial_number(String serial_number);     //按志愿序号查找所有
    List<Student_volunteer> findAllByBatch(int batch);     //按批次查找所有
